...
def resize_and_pad_image(
    image, min_side=600.0, max_side=1000.0, jitter=[640, 1024], stride=128.0
):
...
try:
    tf.config.set_logical_device_configuration(physical_devices[0],[tf.config.LogicalDeviceConfiguration(memory_limit=11200)])
except:
