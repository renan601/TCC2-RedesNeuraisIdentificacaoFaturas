...
"""
## Transform PDFs in 640x640 PNG images with padding when needed and print bbox coordinates relative to height
"""
...
for filename in os.listdir(directory):
    ...
    if os.path.isfile(f):
        ...
        for i in range(len(images)):
            ...
            # Save resized images
            image.save(f'datasetFaturas/ModeloX/{img_count}-{i}.png', 'png')
